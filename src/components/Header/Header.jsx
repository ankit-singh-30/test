      ...
      <div>
        <div className="max-w-[1200px] min-w-[1200px] relative my-0 mx-auto flex items-center h-20">
          ...
          <div className="relative flex items-center ml-7 cursor-pointer mb-[-1px] pr-[10px] text-sm">
            ...
            <span className="block pl-2 text-[#686b78] overflow-ellipsis overflow-hidden">
              Bengaluru, Karnataka, India
            </span>
            <span className="top-1/2 text-sm text-[#fc8019] font-bold ml-1">
              ⬇️
            </span>
          </div>

          <ul className="flex-1 flex flex-row-reverse h-full items-center">
            <li className="mr-16 cursor-pointer">Cart</li>
            <li className="mr-16 cursor-pointer">Sign In</li>
            <li className="mr-16 cursor-pointer">Help</li>
            <li className="mr-16 cursor-pointer">Offers</li>
            <li className="mr-16 cursor-pointer">Search</li>
          </ul>
        </div>
      </div>
    </header>
